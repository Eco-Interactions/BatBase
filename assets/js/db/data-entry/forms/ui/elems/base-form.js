...
export function buildAndAppendRootForm(fields, id) { 
    setScopeParams(_i.mmry('getAllFormMemory'));
...
function getMainFormAndDetailPanelHtml(id, fields) {
    ...
    const detailPanelHtml = _i.panel('getDetailPanelElems', [entity, id, action]);
...
function buildMainForm(fields) { 
    const formWin = _i.util('buildElem', ['div', { id: 'form-main', class: action }]);
