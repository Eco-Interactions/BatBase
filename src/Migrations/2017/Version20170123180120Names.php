 ...
 */
class Version20170123180120Names extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema):void
    {
        ...
        $this->addSql('ALTER TABLE domain CHANGE display_name name VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE interaction_type CHANGE display_name name VARCHAR(255) NOT NULL');
    }
}
