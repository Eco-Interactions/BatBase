...
final class Version20210205ValidInteractionSql extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE valid_interaction (id INT AUTO_INCREMENT NOT NULL, object_group_id INT NOT NULL, subject_group_id INT NOT NULL, interaction_type_id INT DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, INDEX IDX_64A931402882342F (object_group_id), INDEX IDX_64A93140C629992F (subject_group_id), INDEX IDX_64A93140A50ABBF2 (interaction_type_id), INDEX IDX_64A93140DE12AB56 (created_by), INDEX IDX_64A9314016FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE valid_interaction ADD CONSTRAINT FK_64A931402882342F FOREIGN KEY (object_group_id) REFERENCES group_root (id)');
        $this->addSql('ALTER TABLE valid_interaction ADD CONSTRAINT FK_64A93140C629992F FOREIGN KEY (subject_group_id) REFERENCES group_root (id)');
