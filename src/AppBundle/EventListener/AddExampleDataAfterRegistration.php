        ...
        $map = [
            'list' => [
                'bats' => [
                    ...
                    'name' => '(EX:) Phyllostomidae & Pteropodidae - Arthropod'
                ], 
                'source' => [
                    ...
                    'name' => '(EX:) Biotropica, Journal of Mammalogy, & Acta Chiropterologica - Arthropod'
                ]
            ],
            'set' => [
                'brazil' => [
                    ...
                    'name' => '(EX:) Brazil - Arthropod, consumption'
                ], 
                'journal' => [
                    ...
                    'name' => '(EX:) Journals - Arthropod, consumption, >=1990'
                ], 
                'taxon' => [
                    ...
                    'name' => '(EX:) Taxon - Hipposideridae >= 1988'
                ]
            ]
        ];
        return $map[$type][$key];
