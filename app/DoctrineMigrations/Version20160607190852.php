 ...
 */
class Version20160607190852 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE interaction_int_tag DROP FOREIGN KEY FK_B20EB869886DEE8F');
        ...
        $this->addSql('ALTER TABLE int_tag DROP FOREIGN KEY FK_D2488F08DE12AB56');
        $this->addSql('ALTER TABLE int_tag DROP FOREIGN KEY FK_D2488F0816FE72E1');
