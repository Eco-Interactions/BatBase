...
class Version201610101857190SrcStructure extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE contribution (id INT AUTO_INCREMENT NOT NULL, work_src_id INT DEFAULT NULL, auth_src_id INT DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, cited_as VARCHAR(255) DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, INDEX IDX_EA351E15A40CEF8E (work_src_id), INDEX IDX_EA351E152F568E4E (auth_src_id), INDEX IDX_EA351E15DE12AB56 (created_by), INDEX IDX_EA351E1516FE72E1 (updated_by), UNIQUE INDEX unq_contrib (work_src_id, auth_src_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE source (id INT AUTO_INCREMENT NOT NULL, parent_src_id INT DEFAULT NULL, source_type_id INT DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, display_name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, year VARCHAR(255) DEFAULT NULL, doi VARCHAR(255) DEFAULT NULL, link_display VARCHAR(255) DEFAULT NULL, link_url VARCHAR(255) DEFAULT NULL, is_citation TINYINT(1) DEFAULT NULL, is_direct TINYINT(1) DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, deletedAt DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_5F8A7F73D5499347 (display_name), INDEX IDX_5F8A7F7340E6EA6A (parent_src_id), INDEX IDX_5F8A7F738C9334FB (source_type_id), INDEX IDX_5F8A7F73DE12AB56 (created_by), INDEX IDX_5F8A7F7316FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE contribution ADD CONSTRAINT FK_EA351E15A40CEF8E FOREIGN KEY (work_src_id) REFERENCES source (id)');
