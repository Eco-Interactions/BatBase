 ...
 */
final class Version20200312SQL extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE realm_taxon (id INT AUTO_INCREMENT NOT NULL, realm_id INT NOT NULL, taxon_id INT NOT NULL, is_root TINYINT(1) NOT NULL, created DATETIME NOT NULL, created_by INT DEFAULT NULL, updated DATETIME NOT NULL, updated_by INT DEFAULT NULL, INDEX IDX_BCA7F6489DFF5F89 (realm_id), UNIQUE INDEX UNIQ_BCA7F648DE13F470 (taxon_id), INDEX IDX_BCA7F648DE12AB56 (created_by), INDEX IDX_BCA7F64816FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
