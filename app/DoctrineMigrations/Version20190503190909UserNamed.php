...
final class Version20190503190909UserNamed extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_named (id INT AUTO_INCREMENT NOT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, type VARCHAR(255) NOT NULL, display_name VARCHAR(255) NOT NULL, `desc` LONGTEXT NOT NULL, details LONGTEXT NOT NULL, loaded DATETIME NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, deletedAt DATETIME DEFAULT NULL, INDEX IDX_932237DFDE12AB56 (created_by), INDEX IDX_932237DF16FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
