 ...
 */
class Version20160115060438 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE attribution (id INT AUTO_INCREMENT NOT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, citation_id INT DEFAULT NULL, author_id INT DEFAULT NULL, archive TINYINT(1) DEFAULT NULL, cited_as VARCHAR(255) DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, INDEX IDX_C751ED49DE12AB56 (created_by), INDEX IDX_C751ED4916FE72E1 (updated_by), INDEX IDX_C751ED49500A8AB7 (citation_id), INDEX IDX_C751ED49F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE author (id INT AUTO_INCREMENT NOT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, slug VARCHAR(128) DEFAULT NULL, archive TINYINT(1) DEFAULT NULL, full_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, link_display VARCHAR(255) DEFAULT NULL, link_url VARCHAR(255) DEFAULT NULL, short_name VARCHAR(255) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, deletedAt DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_BDAFD8C8989D9B62 (slug), INDEX IDX_BDAFD8C8DE12AB56 (created_by), INDEX IDX_BDAFD8C816FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE authority (id INT AUTO_INCREMENT NOT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, archive TINYINT(1) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, priority INT DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, INDEX IDX_4AF96AFCDE12AB56 (created_by), INDEX IDX_4AF96AFC16FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE citation (id INT AUTO_INCREMENT NOT NULL, publication_id INT DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, archive TINYINT(1) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, full_text LONGTEXT NOT NULL, is_secondary TINYINT(1) DEFAULT NULL, publication_issue VARCHAR(255) DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, deletedAt DATETIME DEFAULT NULL, INDEX IDX_FABD9C7E38B217A7 (publication_id), INDEX IDX_FABD9C7EDE12AB56 (created_by), INDEX IDX_FABD9C7E16FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE domain (id INT AUTO_INCREMENT NOT NULL, taxon_id INT DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, slug VARCHAR(128) DEFAULT NULL, archive TINYINT(1) DEFAULT NULL, name VARCHAR(255) NOT NULL, plural_name VARCHAR(255) DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, UNIQUE INDEX UNIQ_A7A91E0B989D9B62 (slug), UNIQUE INDEX UNIQ_A7A91E0BDE13F470 (taxon_id), INDEX IDX_A7A91E0BDE12AB56 (created_by), INDEX IDX_A7A91E0B16FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE habitat_type (id INT AUTO_INCREMENT NOT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, slug VARCHAR(128) DEFAULT NULL, archive TINYINT(1) DEFAULT NULL, name VARCHAR(255) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, UNIQUE INDEX UNIQ_63B23110989D9B62 (slug), INDEX IDX_63B23110DE12AB56 (created_by), INDEX IDX_63B2311016FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE interaction (id INT AUTO_INCREMENT NOT NULL, citation_id INT DEFAULT NULL, interaction_type_id INT DEFAULT NULL, location_id INT DEFAULT NULL, subject_taxon_id INT DEFAULT NULL, object_taxon_id INT DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, note VARCHAR(255) DEFAULT NULL, archive TINYINT(1) DEFAULT NULL, is_likely TINYINT(1) DEFAULT NULL, is_old_world TINYINT(1) DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, deletedAt DATETIME DEFAULT NULL, INDEX IDX_378DFDA7500A8AB7 (citation_id), INDEX IDX_378DFDA7A50ABBF2 (interaction_type_id), INDEX IDX_378DFDA764D218E (location_id), INDEX IDX_378DFDA7E66EB418 (subject_taxon_id), INDEX IDX_378DFDA78C51918 (object_taxon_id), INDEX IDX_378DFDA7DE12AB56 (created_by), INDEX IDX_378DFDA716FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE interaction_type (id INT AUTO_INCREMENT NOT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, slug VARCHAR(128) DEFAULT NULL, archive TINYINT(1) DEFAULT NULL, is_symmetric TINYINT(1) DEFAULT NULL, name VARCHAR(255) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, UNIQUE INDEX UNIQ_1E1A8229989D9B62 (slug), INDEX IDX_1E1A8229DE12AB56 (created_by), INDEX IDX_1E1A822916FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE level (id INT AUTO_INCREMENT NOT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, archive TINYINT(1) DEFAULT NULL, name VARCHAR(255) NOT NULL, ordinal INT DEFAULT NULL, plural_name VARCHAR(255) DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, INDEX IDX_9AEACC13DE12AB56 (created_by), INDEX IDX_9AEACC1316FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE location (id INT AUTO_INCREMENT NOT NULL, country_id INT DEFAULT NULL, habitat_type_id INT DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, archive TINYINT(1) DEFAULT NULL, description VARCHAR(255) NOT NULL, elevation INT DEFAULT NULL, elev_unit_abbrv VARCHAR(3) NOT NULL, gps_data VARCHAR(255) DEFAULT NULL, latitude NUMERIC(18, 14) DEFAULT NULL, longitude NUMERIC(18, 14) DEFAULT NULL, show_on_map TINYINT(1) DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, deletedAt DATETIME DEFAULT NULL, INDEX IDX_5E9E89CBF92F3E70 (country_id), INDEX IDX_5E9E89CB9955B331 (habitat_type_id), INDEX IDX_5E9E89CBDE12AB56 (created_by), INDEX IDX_5E9E89CB16FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE naming (id INT AUTO_INCREMENT NOT NULL, taxon_id INT DEFAULT NULL, taxonym_id INT DEFAULT NULL, naming_type_id INT DEFAULT NULL, authority_id INT DEFAULT NULL, parent_taxon_id INT DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, archive TINYINT(1) DEFAULT NULL, from_date DATETIME DEFAULT NULL, guid VARCHAR(255) DEFAULT NULL, to_date DATETIME DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, deletedAt DATETIME DEFAULT NULL, INDEX IDX_818CFCD7DE13F470 (taxon_id), INDEX IDX_818CFCD7C30BB132 (taxonym_id), INDEX IDX_818CFCD7FBF60FC7 (naming_type_id), INDEX IDX_818CFCD781EC865B (authority_id), INDEX IDX_818CFCD741DE58A1 (parent_taxon_id), INDEX IDX_818CFCD7DE12AB56 (created_by), INDEX IDX_818CFCD716FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE naming_type (id INT AUTO_INCREMENT NOT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, archive TINYINT(1) DEFAULT NULL, name VARCHAR(255) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, INDEX IDX_EC29668ADE12AB56 (created_by), INDEX IDX_EC29668A16FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE publication (id INT AUTO_INCREMENT NOT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, slug VARCHAR(128) DEFAULT NULL, archive TINYINT(1) DEFAULT NULL, doi VARCHAR(255) DEFAULT NULL, link_display VARCHAR(255) DEFAULT NULL, link_url VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, deletedAt DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_AF3C6779989D9B62 (slug), INDEX IDX_AF3C6779DE12AB56 (created_by), INDEX IDX_AF3C677916FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
