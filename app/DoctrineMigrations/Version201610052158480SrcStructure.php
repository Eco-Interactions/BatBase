 ...
 */
class Version201610052158480SrcStructure extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE contribution (id INT AUTO_INCREMENT NOT NULL, citation_id INT DEFAULT NULL, author_id INT DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, cited_as VARCHAR(255) DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, INDEX IDX_EA351E15500A8AB7 (citation_id), INDEX IDX_EA351E15F675F31B (author_id), INDEX IDX_EA351E15DE12AB56 (created_by), INDEX IDX_EA351E1516FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE source (id INT AUTO_INCREMENT NOT NULL, parent_src_id INT DEFAULT NULL, source_type_id INT DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, slug VARCHAR(128) DEFAULT NULL, display_name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, year VARCHAR(255) DEFAULT NULL, doi VARCHAR(255) DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, deletedAt DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_5F8A7F73989D9B62 (slug), UNIQUE INDEX UNIQ_5F8A7F73D5499347 (display_name), INDEX IDX_5F8A7F7340E6EA6A (parent_src_id), INDEX IDX_5F8A7F738C9334FB (source_type_id), INDEX IDX_5F8A7F73DE12AB56 (created_by), INDEX IDX_5F8A7F7316FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE contribution ADD CONSTRAINT FK_EA351E15500A8AB7 FOREIGN KEY (citation_id) REFERENCES source (id)');
        ...
        $this->addSql('ALTER TABLE publication ADD source_id INT DEFAULT NULL, ADD display_name VARCHAR(255) NOT NULL');
