...
## Creates all sub-entities ##
    ...
    Scenario:  I enter all previous data to jump to this section #COMBO STEP
        ...
        ## Publication Book ##
        And I enter "Test Book" in the "Publication" form dropdown field
        And I see "New Publication"
        And I select "Book" from the "Publication Type" form dropdown field
        ## Publisher ##
        And I enter "Test Publisher" in the "Publisher" form dropdown field
        ...
        ### Author ##
        And I enter "Smith, George" in the "Authors" field dynamic dropdown
        And I check the "Show all fields" box
        ...
        And I enter "Test Book with Editors" in the "Publication" form dropdown field
        And I see "New Publication"
        And I select "Book" from the "Publication Type" form dropdown field
        And I type "1990" in the "Year" field "input"
        And I select "Callaye, Bendry J. Jr" from the "Editors" field dynamic dropdown
        And I select "Test Publisher" from the "Publisher" form dropdown field
        And I check the "Show all fields" box
        And I type "10.1037/rmh0000008" in the "Doi" field "input"
        And I type "Test description" in the "Description" field "textarea"
        And I type "www.publication.com" in the "Link Url" field "input"
        ...
        ## Chapter Citation ##
        And I see "New Citation"
        And I select "Chapter" from the "Citation Type" form dropdown field
        ...
        And I press the "Create Citation" button
        ## Publication Journal ##
        And I enter "Test Journal" in the "Publication" form dropdown field
        And I see "New Publication"
        And I select "Journal" from the "Publication Type" form dropdown field
        And I press the "Create Publication" button
        ## Article Citation ##
        And I see "New Citation"
        And I should see "Article" in the "Citation Type" form dropdown field
        And I type "1990" in the "Year" field "input"
        ...
        And I enter "Test Dissertation" in the "Publication" form dropdown field
        And I see "New Publication"
        And I select "Thesis/Dissertation" from the "Publication Type" form dropdown field
        And I type "1990" in the "Year" field "input"
        ...
        And I see "New Citation"
        And I should see "Ph.D. Dissertation" in the "Citation Type" form dropdown field
        ...
        And I press the "Create Citation" button
        ## Publication Other ##
        And I enter "Test Other" in the "Publication" form dropdown field
        And I see "New Publication"
        And I select "Other" from the "Publication Type" form dropdown field
        And I type "1990" in the "Year" field "input"
        And I select "Callaye, Bendry J. Jr" from the "Authors" field dynamic dropdown
        And I select "Test Publisher" from the "Publisher" form dropdown field
        And I check the "Show all fields" box
        ...
        ## Other Citation ##
        And I see "New Citation"
        And I should see "Other" in the "Citation Type" form dropdown field
        ...
        And I type "Test Description" in the "Description" field "textarea"
        And I select "Savanna" from the "Habitat Type" form dropdown field
        ...
        ## Without GPS ##
        And I focus on the "Location" combobox
        And I enter "Test Location Without GPS" in the "Location" form dropdown field
        And I should see "New Location"
        And I type "Test Description" in the "Description" field "textarea"
        And I select "Costa Rica" from the "Country" form dropdown field
        And I select "Savanna" from the "Habitat Type" form dropdown field
        And I type "1500" in the "Elevation" field "input"
        And I type "2500" in the "Elevation Max" field "input"
        ...
        And I enter "Subject Family" in the "Family" form dropdown field
        And I see "New Taxon Family"
        And I press the "Create Taxon" button
        ### Subject Genus ##
        And I enter "SGenus" in the "Genus" form dropdown field
        And I see "New Taxon Genus"
        And I press the "Create Taxon" button
        ### Subject Species ##
        And I enter "SGenus Species" in the "Species" form dropdown field
        ...
        And I select "Arthropod" from the "Realm" form dropdown field
        And I enter "Object Class" in the "Class" form dropdown field
        And I see "New Taxon Class"
        And I press the "Create Taxon" button
        ### Object Order ##
        And I enter "Object Order" in the "Order" form dropdown field
        And I see "New Taxon Order"
        And I press the "Create Taxon" button
        ### Object Family ##
        And I enter "Object Family" in the "Family" form dropdown field
        And I see "New Taxon Family"
        And I press the "Create Taxon" button
        ### Object Genus ##
        And I enter "OGenus" in the "Genus" form dropdown field
        And I see "New Taxon Genus"
        And I press the "Create Taxon" button
        ### Object Species ##
        And I enter "OGenus Species" in the "Species" form dropdown field
        And I see "New Taxon Species"
        And I press the "Create Taxon" button
        When I press the "Confirm" button
    ## -------------------------- Source ---------------------------------------##
  ...
  #       And I see "New Publication"
  #       And I select "Book" from the "Publication Type" form dropdown field
  #       When I enter "Test Publisher" in the "Publisher" form dropdown field
  #       And I see "New Publisher"
  #       And I type "Nice" in the "City" field "input"
  #       And I type "France" in the "Country" field "input"
  #       And  I check the "Show all fields" box
  ...
  #       And I type "Test Publisher Webiste" in the "Link Display" field "input"
  #       And I press the "Create Publisher" button
  #       Then I should see "Test Publisher" in the "Publisher" form dropdown field
  #   ## ------------------- AUTHOR ----------------- ##
  #   @javascript
  ...
  #       And I type "Test Book Webiste" in the "Link Display" field "input"
  #       And I press the "Create Publication" button
  #       Then I should see "Test Book" in the "Publication" form dropdown field
  ...
  #       And I type "Test Book Webiste" in the "Link Display" field "input"
  #       And I press the "Create Publication" button
  #       Then I should see "Test Book with Editors" in the "Publication" form dropdown field
  ...
  #       Given I press the "New" button
  #       And I see "New Interaction"
  #       And I select "Test Book" from the "Publication" form dropdown field
  #       And I enter "" in the "Citation Title" form dropdown field
  #       And I see "New Citation"
  #       And I should see "Book" in the "Citation Type" form dropdown field
  #       When I type "29" in the "Edition" field "input"
  #       And I should see "Callaye, B. J. 1990. Test Book. 29. Test Publisher, Nice, France." in the "Citation Text" field "textarea"
  #       And I press the "Create Citation" button
  #       Then I should see "Test Book" in the "Citation Title" form dropdown field
  ...
  #       Given I press the "New" button
  #       And I see "New Interaction"
  #       And I select "Test Book with Editors" from the "Publication" form dropdown field
  #       And I see "New Citation"
  #       When I select "Chapter" from the "Citation Type" form dropdown field
  #       And I type "Test Title for Chapter" in the "Title" field "input"
  #       And I type "666-999" in the "Pages" field "input"
  #       And I select "Cockle, Anya" from the "Authors" field dynamic dropdown
  #       And I check the "Show all fields" box
  ...
  #       And I see "Cockle, A. 1990. Test Title for Chapter. In: Test Book with Editors (B. J. Callaye, ed.). pp. 666-999. Test Publisher, Nice, France." in the "Citation Text" field "textarea"
  #       And I press the "Create Citation" button
  #       Then I should see "Test Title for Chapter" in the "Citation Title" form dropdown field
  ...
  #       And I check the "Show all fields" box
  #       And I press the "Create Publication" button
  #       Then I should see "Test Journal" in the "Publication" form dropdown field
  ...
  #       Given I press the "New" button
  #       And I see "New Interaction"
  #       And I select "Test Journal" from the "Publication" form dropdown field
  #       And I see "New Citation"
  #       And I should see "Article" in the "Citation Type" form dropdown field
  #       And I type "1990" in the "Year" field "input"
  #       And I type "Test Title for Article" in the "Title" field "input"
  ...
  #       And I see "Cockle, A. 1990. Test Title for Article. Test Journal 4 (1): 666-999." in the "Citation Text" field "textarea"
  #       And I press the "Create Citation" button
  #       Then I should see "Test Title for Article" in the "Citation Title" form dropdown field
  ...
  #       And I enter "Test Dissertation" in the "Publication" form dropdown field
  #       And I see "New Publication"
  #       When I select "Thesis/Dissertation" from the "Publication Type" form dropdown field
  #       And I type "1990" in the "Year" field "input"
  #       And I select "Callaye, Bendry J. Jr" from the "Authors" field dynamic dropdown
  #       And I select "Test Publisher" from the "Publisher" form dropdown field
  #       And I check the "Show all fields" box
  ...
  #       And I type "Test Book Webiste" in the "Link Display" field "input"
  #       And I press the "Create Publication" button
  #       Then I should see "Test Dissertation" in the "Publication" form dropdown field
  ...
  #       Given I press the "New" button
  #       And I see "New Interaction"
  #       And I select "Test Dissertation" from the "Publication" form dropdown field
  #       And I see "New Citation"
  #       And I should see "Ph.D. Dissertation" in the "Citation Type" form dropdown field
  #       And I see "Callaye, B. J. 1990. Test Dissertation. Ph.D. Dissertation. Test Publisher, Nice, France." in the "Citation Text" field "textarea"
  #       And I check the "Show all fields" box
  #       And I press the "Create Citation" button
  #       Then I should see "Test Dissertation" in the "Citation Title" form dropdown field
  ...
  #       And I enter "Test Other" in the "Publication" form dropdown field
  #       And I see "New Publication"
  #       When I select "Other" from the "Publication Type" form dropdown field
  #       And I type "1990" in the "Year" field "input"
  #       And I select "Callaye, Bendry J. Jr" from the "Authors" field dynamic dropdown
  #       And I select "Test Publisher" from the "Publisher" form dropdown field
  #       And I check the "Show all fields" box
  ...
  #       And I type "Test Other Webiste" in the "Link Display" field "input"
  #       And I press the "Create Publication" button
  #       Then I should see "Test Other" in the "Publication" form dropdown field
  ...
  #       Given I press the "New" button
  #       And I see "New Interaction"
  #       And I select "Test Other" from the "Publication" form dropdown field
  #       And I see "New Citation"
  #       And I should see "Other" in the "Citation Type" form dropdown field
  #       And I see "Callaye, B. J. 1990. Test Other. Test Publisher, Nice, France." in the "Citation Text" field "textarea"
  #       And I check the "Show all fields" box
  #       And I press the "Create Citation" button
  #       Then I should see "Test Other" in the "Citation Title" form dropdown field
  ...
  #       # And I see the country's polygon drawn on the map  #(Couldn't identify elem)
  #       And I press "Create Location" in the added green pin's popup
  #       Then I should see "Test Location With GPS" in the "Location" form dropdown field
  #       And I should see "Test Description" in the "Location" detail panel
  #       And I should see "Costa Rica" in the "Country-Region" form dropdown field
  ...
  #       And I type "2500" in the "Elevation Max" field "input"
  #       And I press the "Create without GPS data" button
  #       Then I should see "Test Location Without GPS" in the "Location" form dropdown field
  #       And I should see "Test Description" in the "Location" detail panel
  #       And I should see "Savanna" in the "Location" detail panel
  #       And I should see "1500" in the "Location" detail panel
  #       And I should see "2500" in the "Location" detail panel
  ...
  #       And I select "Costa Rica" from the "Country-Region" form dropdown field
  ...
  #   #     And the marker's popup should have a description of the position 
    ...
    #     And I focus on the "Subject" taxon field
    #     And I see "Select Subject Taxon"
    #     When I enter "Subject Family" in the "Family" form dropdown field
    #     And I see "New Taxon Family"
    #     And I press the "Create Taxon" button
    #     Then I should see "Subject Family" in the "Family" form dropdown field
    ...
    #     And I focus on the "Subject" taxon field
    #     And I see "Select Subject Taxon"
    #     And I select "Subject Family" from the "Family" form dropdown field
    #     When I enter "SGenus" in the "Genus" form dropdown field
    #     And I see "New Taxon Genus"
    #     And I press the "Create Taxon" button
    #     Then I should see "Subject Family" in the "Family" form dropdown field
    #     And I should see "SGenus" in the "Genus" form dropdown field
    ...
    #     And I focus on the "Subject" taxon field
    #     And I see "Select Subject Taxon"
    #     And I select "SGenus" from the "Genus" form dropdown field
    #     When I enter "SGenus Species" in the "Species" form dropdown field
    #     And I see "New Taxon Species"
    #     And I press the "Create Taxon" button
    #     Then I should see "SGenus Species" in the "Species" form dropdown field
    #     And I should see "Subject Family" in the "Family" form dropdown field
    #     And I should see "SGenus" in the "Genus" form dropdown field
    ...
    #     And I focus on the "Subject" taxon field
    #     And I see "Select Subject Taxon"
    #     And I select "SGenus Species" from the "Species" form dropdown field
    #     When I press the "Confirm" button
    #     Then I should see "SGenus Species" in the "Subject" form dropdown field
    ...
    #     And I focus on the "Object" taxon field
    #     And I see "Select Object Taxon"
    #     When I select "Arthropod" from the "Realm" form dropdown field
    #     And I enter "Object Class" in the "Class" form dropdown field
    #     And I see "New Taxon Class"
    #     And I press the "Create Taxon" button
    #     Then I should see "Object Class" in the "Class" form dropdown field
    ...
    #     And I see "Select Object Taxon"
    #     When I select "Arthropod" from the "Realm" form dropdown field
    #     And I select "Object Class" from the "Class" form dropdown field
    #     And I enter "Object Order" in the "Order" form dropdown field
    #     And I see "New Taxon Order"
    #     And I press the "Create Taxon" button
    #     Then I should see "Object Order" in the "Order" form dropdown field
    #     And I should see "Object Class" in the "Class" form dropdown field
    ...
    #     And I see "Select Object Taxon"
    #     When I select "Arthropod" from the "Realm" form dropdown field
    #     And I select "Object Order" from the "Order" form dropdown field
    #     And I enter "Object Family" in the "Family" form dropdown field
    #     And I see "New Taxon Family"
    #     And I press the "Create Taxon" button
    #     Then I should see "Object Family" in the "Family" form dropdown field        
    #     And I should see "Object Class" in the "Class" form dropdown field
    #     And I should see "Object Order" in the "Order" form dropdown field
    ...
    #     And I see "Select Object Taxon"
    #     When I select "Arthropod" from the "Realm" form dropdown field
    #     And I select "Object Family" from the "Family" form dropdown field
    #     When I enter "OGenus" in the "Genus" form dropdown field
    #     And I see "New Taxon Genus"
    #     And I press the "Create Taxon" button
    #     Then I should see "OGenus" in the "Genus" form dropdown field     
    #     And I should see "Object Family" in the "Family" form dropdown field
    #     And I should see "Object Order" in the "Order" form dropdown field
    #     And I should see "Object Class" in the "Class" form dropdown field
    ...
    #     And I see "Select Object Taxon"
    #     When I select "Arthropod" from the "Realm" form dropdown field
    #     And I select "OGenus" from the "Genus" form dropdown field
    #     When I enter "OGenus Species" in the "Species" form dropdown field
    #     And I see "New Taxon Species"
    #     And I press the "Create Taxon" button
    #     Then I should see "OGenus Species" in the "Species" form dropdown field
    #     And I should see "OGenus" in the "Genus" form dropdown field     
    #     And I should see "Object Family" in the "Family" form dropdown field
    #     And I should see "Object Order" in the "Order" form dropdown field
    #     And I should see "Object Class" in the "Class" form dropdown field
    ...
    #     And I see "Select Object Taxon"
    #     When I select "Arthropod" from the "Realm" form dropdown field
    #     And I select "OGenus Species" from the "Species" form dropdown field
    #     When I press the "Confirm" button
    #     Then I should see "OGenus Species" in the "Object" form dropdown field
    #     
    ...
    Scenario:  Pinned field values should remain after interaction form submission (all others should clear)
        ...
        And I press the "Create Interaction" button
        Then I should see "New Interaction successfully created." in the form header
        And I should see "Test Book with Editors" in the "Publication" form dropdown field
        And I should see "Test Title for Chapter" in the "Citation Title" form dropdown field
        And I should see "Costa Rica" in the "Country-Region" form dropdown field
        And I should see "Test Location With GPS" in the "Location" form dropdown field
        And I should see "Genus SGenus" in the "Subject" form dropdown field
        And I should see "Consumption" in the "Interaction Type" form dropdown field
...
## ===================== AFTER INTERACTION FORM SUBMIT ====================== ##
    ...
    Scenario:  The table should reload in Source view after creating an interaction.
        ...
        And the table should be filtered to interactions created today
